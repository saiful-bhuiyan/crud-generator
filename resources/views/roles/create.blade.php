                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input permission-checkbox" name="permissions[]" value="{{ $actions[$action] }}" id="{{ $actions[$action] }}">
...
<script>
    ...
    // Call on load (in case of old input or defaults)
